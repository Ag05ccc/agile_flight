    ...
    def add_steps_and_auto_finish(
        ...
        for env_idx, (act, ob, rew, done, info) in zip_iter:
            ...
            if done:
                ...
                real_ob = ob#types.maybe_wrap_in_dictobs(info["terminal_observation"])
            else:
                real_ob = ob
...
def generate_trajectories(
    ...
    *,
    ...
    # DEBUG
    obs_trim = {key: value[:, :65] for key, value in obs.items()}
    ...
    # DEBUG
    wrapped_obs = types.maybe_wrap_in_dictobs(obs_trim)
    # wrapped_obs = types.maybe_wrap_in_dictobs(obs)
    ...
    for trajectory in trajectories:
        ...
        # DEBUG - Manuel degistirdigimiz icin uyari kapattik
